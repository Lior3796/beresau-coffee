        ...
        <div className="flex items-center justify-between h-16">
          <div className="flex-shrink-0">
            <span className={`text-2xl font-bold text-coffee-800  ${
                ...
                }`}><a href="https://beresau.co.il/?gad_source=1&gclid=Cj0KCQjw782_BhDjARIsABTv_JAE97wGb1SwevwQJPWSasXnKjq76C3qRucJpGrpFcSw4qvufUoqyLMaArXCEALw_wcB">קפה ברסאו</a></span>
          </div>
