...
const Footer = () => {
  ...
  const whatsAppText = encodeURI("הגעתי דרך עמוד נחיתה");
  useEffect(() => {
      ...
      >
        <div className="flex flex-col md:flex-row gap-16 mb-20">
          ...
          >
            ...
            >
              <motion.a 
                href="https://www.facebook.com/profile.php?id=61565156337680"
                target="_blank" 
                aria-label="Facebook"
                whileHover="hover"
              ...
              <motion.a 
                href="https://www.instagram.com/beresau_coffee/"
                target="_blank" 
              ...
              <motion.a 
                ...
                variants={socialVariants}
              >
                <img src="/images/whatsapp-icon.svg" alt="WhatsApp" className="w-6 h-6" />
              </motion.a>
            </motion.div>
          </motion.div>
        </div>
