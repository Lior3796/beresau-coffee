    ...
    <section className="hero-section flex items-center justify-center">
      <div className="container max-w-3xl text-center">
        <div className="text-white mb-8">
          <h1 className="text-7xl mb-6 font-varela leading-tight tracking-tighter">ברסאו – קפה אתיופי משובח</h1>
          <p className="text-xl">קפה איכותי המשלב מסורת, תרבות ואיכות בלתי מתפשרת</p>
        </div>
        <div>
