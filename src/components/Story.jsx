            ...
            >
              <div className="flex flex-col items-center md:items-end text-center md:text-right w-full">
                ...
                <motion.p 
                  ...
                  variants={itemVariants}
                >
                  ברסאו שמו השני של אח שלנו אברהם שמשמעותו "אם אשכח אותו" נולד מתוך סיפור משפחתי מרגש ומחויבות להמשיך את מורשתו של אברהם ז"ל. כל כוס קפה מספרת את הסיפור של אתיופיה, עם פולי קפה מובחרים שנבחרו בקפידה.
                </motion.p>
                <motion.p 
